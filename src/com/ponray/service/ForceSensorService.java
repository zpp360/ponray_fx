...
public class ForceSensorService {
     ...
     */
    public int insert(String name,int range) throws SQLException, ClassNotFoundException {
        Connection conn = AccessHelper.getConnection();
        String sql = "insert into t_force_sensor(name,range,LN,YN,LP,YP,LH,YH,selected) values (?,?,?,?,?,?,?,?,?)";
     ...
     * @throws ClassNotFoundException
     */
    public int update(long ID,String name,int range) throws SQLException, ClassNotFoundException {
        Connection conn = AccessHelper.getConnection();
    ...
    public List<DataMap> list() throws SQLException, ClassNotFoundException {
        ...
        while(set.next()){
            ...
            map.put("range",set.getInt("range"));
